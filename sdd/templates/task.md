...
|---|---|---|
| `src/navigator_eventbus/path/to/new_file.py` | CREATE | Main implementation |
| `tests/unit/test_new_file.py` | CREATE | Unit tests |
| `src/navigator_eventbus/path/to/existing.py` | MODIFY | Add import / register component |
...
```python
from navigator_eventbus.module import ClassName  # verified: src/navigator_eventbus/module/__init__.py:NN
```
...
```python
# src/navigator_eventbus/path/to/file.py:NN
...
- ~~`navigator_eventbus.module.NonExistentThing`~~ — does not exist
...
# e.g. copy this structure from src/navigator_eventbus/loaders/base.py
...
- `src/navigator_eventbus/path/reference1.py` — pattern to follow
- `src/navigator_eventbus/path/reference2.py` — integration point
...
- [ ] No linting errors: `ruff check src/navigator_eventbus/<path>`
- [ ] Imports work: `from navigator_eventbus.<module> import <Component>`
- [ ] Criterion N
...
import pytest
from navigator_eventbus.<module> import <Component>
